...
using delta-from-WT max-abs ESM features (parallel to result_analysis_nmut_split.py
which uses raw mean-pooled features).

Outputs to ./output/nmut_split_delta/:
...
out_dir = Path("output") / "nmut_split_delta"
...
# Find WT sequence for delta computation.
