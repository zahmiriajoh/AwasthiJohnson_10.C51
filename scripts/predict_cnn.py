"""
CLI entrypoint for scoring novel sequences with the CNN.
...
Usage:
    ...
    python scripts/predict_cnn.py \
        --checkpoint checkpoints/cnn/epoch_012_acc0.8234.pt \
...
import torch
import pandas as pd
from nucb_cnn.utils.io import load_checkpoint
from nucb_cnn.data.encoding import tokenize, ACTIVITY_CLASSES
...
def parse_args():
    p = argparse.ArgumentParser(description="Score NucB variants with a trained CNN checkpoint")
